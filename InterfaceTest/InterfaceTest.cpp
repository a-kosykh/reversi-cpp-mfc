...
// InterfaceTest.cpp : Определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CInterfaceTestApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// создание CInterfaceTestApp

CInterfaceTestApp::CInterfaceTestApp()
{
...
// Единственный объект CInterfaceTestApp

CInterfaceTestApp theApp;


// инициализация CInterfaceTestApp

BOOL CInterfaceTestApp::InitInstance()
{
